...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchPost: function fetchPost() {
      ...
      window.axios.get("/api/categories/" + this.$route.params.category).then(function (resp) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchPost: function fetchPost() {
      ...
      window.axios.get("/api/posts/" + this.$route.params.id).then(function (resp) {
...
// module
exports.push([module.i, "nav .router-link-exact-active {\n  color: red !important;\n}", ""]);
      ...
      _c(
        ...
        [
          _c(
            "router-link",
            {
              staticClass: "navbar-brand router-link-active",
              attrs: { to: "/" },
            },
            [_vm._v("\n         Laravel-Blog\n        ")]
          ),
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      {
                        staticClass:
                          "nav-link px-lg-3 py-3 py-lg-4 router-link-active",
                        attrs: { to: "/" },
                      },
                      [_vm._v("Home")]
                    ),
  ...
  return _c("main", [
    _vm.loading
      ? _c(
          ...
          {
            staticClass:
              "loading-shell d-flex align-items-center justify-content-center",
          },
          [_vm._m(0)]
        )
      : _c("div", [
          _c("div", { staticClass: "container" }, [
            _c("div", { staticClass: "mt-5 row justify-content-between" }, [
                  ...
                  _vm._l(_vm.posts, function (post) {
                    return _c(
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _c("p", [
                          _c("small", [_vm._v(_vm._s(post.category.cat_name))]),
                        ]),
                        _vm._v(" "),
              ...
              _vm._v(" "),
              _c("div", { staticClass: "col-4 categories-col" }, [
                _c("h3", { staticClass: "ms-4 mt-5" }, [_vm._v("Categories:")]),
                _vm._v(" "),
                _c(
                  "ul",
                  [
...
var render = function () {
  ...
  return _c("div", [
    _c("h2", { staticClass: "text-center" }, [
      _vm._v("Categories Details " + _vm._s(_vm.category.cat_name)),
    ]),
    _vm._v(" "),
    _c(
      "div",
      ...
      _vm._l(_vm.category.posts, function (post) {
        return _c("div", { key: post.id, staticClass: "p-2 mb-4 " }, [
          _c("h3", [_vm._v(_vm._s(post.title))]),
          _vm._v(" "),
          _c("p", {
            domProps: { innerHTML: _vm._s(post ? post.content : "") },
          }),
        ])
      }),
      0
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("p", [
        _vm._v("Created " + _vm._s(_vm.post ? _vm.post.created_at : "")),
      ]),
      _vm._v(" "),
      _c("p", [_vm._v(_vm._s(_vm.post ? _vm.post.user.name : ""))]),
      _vm._v(" "),
      _c("small", [_vm._v(_vm._s(_vm.post ? _vm.post.category.cat_name : ""))]),
      _vm._v(" "),
      _vm._l(_vm.post ? _vm.post.tags : "", function (tag) {
        return _c(
          "span",
          {
            key: tag.id,
...
module.exports = __webpack_require__(/*! C:\Sonia\Boolean\Esercizi\laravel-boolpress\resources\js\vue.js */"./resources/js/vue.js");
